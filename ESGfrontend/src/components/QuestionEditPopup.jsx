  ...
  return (
    ...
    >
      <div className="relative">
        <motion.div
          className={`bg-white rounded-2xl shadow-xl transition-all duration-700 ease-in-out flex flex-col overflow-hidden ${
            isAIAssistantOpen ? "w-[90vw] max-w-6xl" : "w-[70vw] max-w-4xl"
          } h-[80vh]`}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {question.type === "table" &&
              (() => {
                ...
                const currentTable =
                  currentValue?.table ||
                  createEmptyTableResponse({ ...meta, columns });
                const tableWithSNo = {
                  columns,
